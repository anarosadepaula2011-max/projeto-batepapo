...
username = st.sidebar.text_input("Nome de usuário", key="usarname", value="Anônimo")
...
entrada_usuário = st.chat_input("Digite uma mensagem")

if entrada_usuário:
    adicionar_mensagens(username, entrada_usuário)
    st.rerun()
